...
//        Для собственных проверок можете делать любые изменения в этом методе
    ...
    /**
     * Метод вернет индекс среднего индекса массива, если ключ совпадет с полученным значением.
     ...
     * Процесс продолжится до тех пор, пока не будет найден индекс
     ...
     * А элемент 18 находится под индексом 6 в искомом массиве.
     *
     ...
     * </ul>
     */
    public static int find(int[] girlAges, int targetAge) {
        // Ваш код
        return 0;
    }
}
