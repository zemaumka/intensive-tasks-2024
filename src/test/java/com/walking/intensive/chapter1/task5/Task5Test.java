...
class Task5Test {
    ...
    void getAreaByHeronTest() {
        ...
        assertEquals(120.0, getAreaByHeron(17, 17, 16));
    ...
    void getHeightsTest() {
        ...
        assertArrayEquals(new double[]{}, getHeights(17, 17, 1));
    ...
    void getMediansTest() {
        ...
        assertArrayEquals(new double[]{}, getMedians(17, 17, 1));
    }
    ...
    void getBisectorsTest() {
        ...
        assertArrayEquals(new double[]{}, getBisectors(17, 17, 1));
    }
    ...
    void getAnglesTest() {
        ...
        assertArrayEquals(new double[]{}, getAngles(17, 17, 1));
    }
    ...
    void getInscribedCircleRadiusTest() {
        ...
        assertEquals(-1.0, getInscribedCircleRadius(17, 17, 1));
    }
    ...
    void getCircumradiusTest() {
        ...
        assertEquals(-1.0, getCircumradius(17, 17, 1));
    }
    ...
    void getAreaAdvancedTest() {
        ...
        assertEquals(-1.0, getAreaAdvanced(17, 17, 1), 1e-10);
    }
}