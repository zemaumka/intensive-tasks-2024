...
class Task5Test {
    ...
    void getAreaByHeronTest() {
        ...
        assertEquals(-1.0, getAreaByHeron(12, 1, 4), 1e-10);
        assertEquals(-1.0, getAreaByHeron(17, 1,1), 1e-10);
        assertEquals(-1.0, getAreaByHeron(17, 1, 1), 1e-10);
        assertEquals(-1.0, getAreaByHeron(0, 10, 20), 1e-10);
        assertEquals(-1.0, getAreaByHeron(20, 0, 10), 1e-10);
        assertEquals(-1.0, getAreaByHeron(10, 20, 0), 1e-10);
        assertEquals(-1.0, getAreaByHeron(-1, 10, 10), 1e-10);
        assertEquals(-1.0, getAreaByHeron(10, -1, 10), 1e-10);
        assertEquals(-1.0, getAreaByHeron(10, 10, -1), 1e-10);
    }
    ...
    void getHeightsTest() {
        ...
        assertArrayEquals(new double[]{4.615, 5.0, 12.0}, getHeights(12, 13, 5));
    ...
    void getInscribedCircleRadiusTest() {
        ...
        assertEquals(-1.0, getInscribedCircleRadius(17, 1, 1), 1e-10);
        assertEquals(-1.0, getInscribedCircleRadius(5, 0, 9), 1e-10);
        assertEquals(-1.0, getInscribedCircleRadius(8, 7, -13), 1e-10);
    }
    ...
    void getCircumradiusTest() {
        ...
        assertEquals(-1.0, getCircumradius(17, 1, 1), 1e-10);
        assertEquals(-1.0, getCircumradius(7, 0, 19), 1e-10);
        assertEquals(-1.0, getCircumradius(-6, 8, 5), 1e-10);
    }
    ...
    void getAreaAdvancedTest() {
        ...
        assertEquals(-1.0, getAreaAdvanced(17, 1, 1), 1e-10);
        assertEquals(-1.0, getAreaAdvanced(7, -9, 10), 1e-10);
        assertEquals(-1.0, getAreaAdvanced(0, 8, 16), 1e-10);
    }
}
