...
class Task4Test {
    ...
    static Stream<Arguments> dataSource() {
        return Stream.of(
                ...
                of("Количество решений: 1. Корень: 1", 0, -2, 2),
                of("Количество решений: 1. Корень: 2", 0, -2, 4),
                of("Количество решений: 1. Корень: 4", 0, -2, 8),
                of("Количество решений: 1. Корень: 2", 0, 20, -40),
                of("Количество решений: 1. Корень: 8", 0, 10, -80),
                ...
                of("Количество решений: 2. Корни: -5;-4", 1, 9, 20),
                of("Количество решений: 2. Корни: -3;-2", 1, 5, 6),
                of("Количество решений: 2. Корни: 3;5", 1, -8, 15),
                of("Количество решений: 2. Корни: -9;5", 1, 4, -45),
                of("Количество решений: 2. Корни: -1;4", -1, 3, 4)
        );
    }
}
